				...
				<section>
                    <section>
    					...
    					<p id="example-name-url">
    						Open <a href="https://laravel-echo.unni.in/audience">bit.ly/laravel-echo</a>
    					</p>
    					<p id="example-name-help-text">
    						Enter your name in text field
    					</p>
                        <p id="example-name-help-text-down"></p>
                        <img class="plain laravel-color" src="/img/bit.ly_laravel-echo.svg" alt="bit.ly/laravel-echo" />
                    </section>
                    <section>
                        <h2>Orders</h2>
                        <table>
                            ...
                            <tbody>
                                <tr id="orderid1">
                                    ...
                                    <td>Biriyani</td>
                                    <td>1</td>
                                    <td><button id="accept-order1" class="accept-order" orderId="orderid1">Accept Order</button></td>
                                </tr>
                                <tr>
                                    <td>@unni</td>
                                    <td>Veg Biriyani</td>
